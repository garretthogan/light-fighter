...
2. **CORS**  
   Configure the leaderboard service so its `CorsOrigin` includes your game origin (e.g. `https://garretthogan.github.io`). If the leaderboard allows `*`, it will work without changes.
